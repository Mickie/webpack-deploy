...
(function () {
    ...
    function b(n, t, r, e, u, o) {
        ...
        return 1 & r || (i = l && pn.call(n, "__wrapped__"), f = c && pn.call(t, "__wrapped__"), !i && !f) ? !!a && (r = R(n, t, r, e, u, o), o.pop(), r) : (i = i ? n.value() : n, f = f ? t.value() : t,
    ...
    function d(n) {
        ...
        return function (r) {
            ...
            for (r = Object(r); e--;) {
                var u = t[e];
                if (!(u in r && y(n[u], r[u], 3)))return false
            }
            return true
        }
    }
