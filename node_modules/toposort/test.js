...
suite.addBatch(
    ...
    }, 'simple cyclic graphs': { topic: function () {
        /*
         foo<->bar
         */
        return toposort(
    ...
    }, 'complex cyclic graphs': { topic: function () {
        /*
         foo
         |
         bar<-john
    ...
    }, 'unknown nodes in edges': { topic: function () {
    ...
    }, 'triangular dependency': { topic: function () {
        /*
         a-> b
         |  /
         c<-
    ...
    }, 'toposort.array': { topic: function () {
        return toposort.array(['d', 'c', 'a', 'b'], [
            ['a', 'b'],
            ['b', 'c']
        ])
    ...
    }, 'toposort.array mutation': { topic: function () {
        var array = ['d', 'c', 'a', 'b']
        toposort.array(array, [
            ['a', 'b'],
            ['b', 'c']
        ])
        return array
