...
(this.define || function (N, O) {
    ...
    (function p(v, l, c) {
        ...
        for (var k = "function" == typeof require && require, r = 0; r < c.length; r++)e(c[r]);
        return e
    })({1: [function (p, v, l) {
        N = p("./source-map-support")
    }, {"./source-map-support": 19}], 2: [function (p, v, l) {
        (function (c) {
            function e(c) {
                c = c.charCodeAt(0);
            ...
            c.toByteArray = function (c) {
                ...
                var f = 0;
                for (a = 0; a < h; a += 4)n = e(c.charAt(a)) << 18 | e(c.charAt(a + 1)) << 12 | e(c.charAt(a + 2)) << 6 | e(c.charAt(a + 3)), d((n & 16711680) >> 16), d((n & 65280) >> 8), d(n & 255);
            ...
            c.fromByteArray = function (c) {
                var d, a = c.length % 3, h = "", n, e;
                d = 0;
                for (e = c.length - a; d < e; d += 3)n = (c[d] << 16) + (c[d + 1] << 8) + c[d + 2], n = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(n >>
                    18 & 63) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(n >> 12 & 63) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(n >> 6 & 63) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(n & 63), h += n;
                switch (a) {
                    case 1:
                        n = c[c.length - 1];
                    ...
                    case 2:
                        n = (c[c.length - 2] << 8) +
                            c[c.length - 1], h += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(n >> 10), h += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(n >> 4 & 63), h += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(n << 2 & 63), h += "="
                }
                return h
            }
        ...
        function c(g, m, b) {
            if (!(this instanceof c))return new c(g, m, b);
            var y = typeof g;
            if ("base64" === m && "string" === y)for (g = g.trim ?
                g.trim() : g.replace(/^\s+|\s+$/g, ""); 0 !== g.length % 4;)g += "=";
            var a;
            if ("number" === y)a = G(g); else if ("string" === y)a = c.byteLength(g, m); else if ("object" === y)a = G(g.length); else throw Error("First argument needs to be a number, array or string.");
            var f;
            ...
            if (c._useTypedArrays && "number" === typeof g.byteLength)f._set(g); else {
                var d = g;
                if (L(d) || c.isBuffer(d) || d && "object" === typeof d && "number" === typeof d.length)for (m = 0; m < a; m++)c.isBuffer(g) ?
                    f[m] = g.readUInt8(m) : f[m] = g[m]; else if ("string" === y)f.write(g, 0, m); else if ("number" === y && !c._useTypedArrays && !b)for (m = 0; m < a; m++)f[m] = 0
            }
            return f
        }
        ...
        function e(g, m, b) {
            var y = "";
            for (b = Math.min(g.length, b); m < b; m++)y += String.fromCharCode(g[m]);
            return y
        }
        ...
        function k(g, m, b, a) {
            ...
            a = g.length;
            if (!(m >= a))return b ? (b = g[m], m + 1 < a && (b |= g[m + 1] << 8)) : (b = g[m] << 8, m + 1 < a && (b |= g[m +
                1])), b
        }
        ...
        function d(g, m, b, a) {
            a || (q("boolean" === typeof b, "missing or invalid endian"), q(void 0 !== m && null !== m, "missing offset"), q(m +
                1 < g.length, "Trying to read beyond buffer length"));
            if (!(m >= g.length))return g = k(g, m, b, !0), g & 32768 ? -1 * (65535 - g + 1) : g
        }

        function a(g, m, b, a) {
            a || (q("boolean" === typeof b, "missing or invalid endian"), q(void 0 !== m && null !== m, "missing offset"), q(m + 3 < g.length, "Trying to read beyond buffer length"));
            if (!(m >= g.length))return g = r(g, m, b, !0), g & 2147483648 ? -1 * (4294967295 - g + 1) : g
        }
        ...
        function t(g, m, b, a, c) {
            ...
            var y = g.length;
            if (!(b >= y))for (c = 0, y = Math.min(y - b, 2); c < y; c++)g[b + c] = (m & 255 << 8 * (a ? c : 1 - c)) >>> 8 * (a ? c : 1 - c)
        }
        ...
        function b(g, b, a, c, f) {
            ...
            var m = g.length;
            if (!(a >= m))for (f = 0, m = Math.min(m - a, 4); f < m; f++)g[a + f] = b >>> 8 * (c ? f : 3 - f) & 255
        }

        function f(g, b, a, c, f) {
            f || (q(void 0 !== b && null !== b, "missing value"), q("boolean" === typeof c, "missing or invalid endian"), q(void 0 !== a && null !== a, "missing offset"), q(a + 1 < g.length, "Trying to write beyond buffer length"),
                z(b, 32767, -32768));
        ...
        function u(g, b, a, c, f) {
            f || (q(void 0 !== b && null !== b, "missing value"), q("boolean" === typeof c, "missing or invalid endian"), q(void 0 !==
                a && null !== a, "missing offset"), q(a + 3 < g.length, "Trying to write beyond buffer length"), D(b, 3.4028234663852886E38, -3.4028234663852886E38));
        ...
        function x(g) {
            for (var b = [], a = 0; a < g.length; a++) {
                ...
                if (127 >= c)b.push(g.charCodeAt(a)); else {
                    ...
                    for (f =
                             0; f < c.length; f++)b.push(parseInt(c[f], 16))
                }
            }
            return b
        }
        ...
        function A(g, b, a, c) {
            for (var m = 0; m < c && !(m + a >= b.length || m >= g.length); m++)b[m + a] = g[m];
            return m
        }
        ...
        c.prototype.write = function (g, b, a, f) {
            ...
            switch (f) {
                case "hex":
                    ...
                    a > f / 2 && (a = f / 2);
                    for (f = 0; f < a; f++)m = parseInt(g.substr(2 * f, 2), 16), q(!isNaN(m), "Invalid hex string"), this[b + f] = m;
                    c._charsWritten = 2 * f;
                    g = f;
                    break;
                case "utf8":
                ...
                case "utf16le":
                case "utf-16le":
                    for (var d, m = [], h = 0; h < g.length; h++)d =
                        g.charCodeAt(h), f = d >> 8, d %= 256, m.push(d), m.push(f);
        ...
        c.prototype.toString = function (g, b, a) {
            ...
            switch (g) {
                case "hex":
                    ...
                    if (!b || 0 > b)b = 0;
                    if (!a || 0 > a || a > g)a = g;
                    for (g = ""; b < a; b++)g += B(this[b]);
                    a = g;
                    break;
                case "utf8":
                case "utf-8":
                    var f = g = "";
                    for (a = Math.min(this.length, a); b < a; b++)127 >= this[b] ? (g += E(f) + String.fromCharCode(this[b]),
                        f = "") : f += "%" + this[b].toString(16);
                    a = g + E(f);
                    break;
                case "ascii":
                    a = e(this, b, a);
        ...
        c.prototype.copy = function (g, b, a, f) {
            ...
            f || 0 === f || (f = this.length);
            b || (b = 0);
            if (f !== a && 0 !== g.length && 0 !== this.length)if (q(f >= a, "sourceEnd < sourceStart"), q(0 <= b && b < g.length, "targetStart out of bounds"), q(0 <= a && a < this.length, "sourceStart out of bounds"), q(0 <= f && f <= this.length, "sourceEnd out of bounds"), f > this.length && (f = this.length), g.length - b < f - a && (f = g.length - b + a), f -= a, 100 > f || !c._useTypedArrays)for (var m = 0; m < f; m++)g[m + b] = this[m + a]; else g._set(this.subarray(a, a + f), b)
        };
        c.prototype.slice =
            function (g, a) {
                var b = this.length;
                g = I(g, b, 0);
                a = I(a, b, b);
                if (c._useTypedArrays)return c._augment(this.subarray(g, a));
                for (var b = a - g, f = new c(b, void 0, !0), m = 0; m < b; m++)f[m] = this[m + g];
                return f
            };
        ...
        c.prototype.readUInt8 = function (b, a) {
            a || (q(void 0 !== b && null !==
                b, "missing offset"), q(b < this.length, "Trying to read beyond buffer length"));
        ...
        c.prototype.fill = function (b, a, f) {
            ...
            q(f >= a, "end < start");
            if (f !== a && 0 !== this.length)for (q(0 <= a && a < this.length, "start out of bounds"), q(0 <= f && f <= this.length,
                "end out of bounds"); a < f; a++)this[a] = b
        };
        c.prototype.inspect = function () {
            for (var b = [], a = this.length, f = 0; f < a; f++)if (b[f] = B(this[f]), f === l.INSPECT_MAX_BYTES) {
                b[f + 1] = "...";
                break
            }
    ...
    }, {"base64-js": 2, ieee754: 5}], 5: [function (p, v, l) {
        l.read = function (c, e, k, r, d) {
            var a;
            a = 8 * d - r - 1;
            var h = (1 << a) - 1, n = h >> 1, t = -7;
            d = k ? d - 1 : 0;
            var b = k ? -1 : 1, f = c[e + d];
            d += b;
            k = f & (1 << -t) - 1;
        ...
        l.write = function (c, e, k, r, d, a) {
            var h,
                n = 8 * a - d - 1, t = (1 << n) - 1, b = t >> 1, f = 23 === d ? Math.pow(2, -24) - Math.pow(2, -77) : 0;
            a = r ? 0 : a - 1;
            var F = r ? 1 : -1, u = 0 > e || 0 === e && 0 > 1 / e ? 1 : 0;
            e = Math.abs(e);
        ...
        (function (c) {
            function e(a, c) {
                for (var d = 0, h = a.length - 1; 0 <= h; h--) {
                    var b = a[h];
            ...
            function k(a, c) {
                ...
                for (var d = [], h = 0; h < a.length; h++)c(a[h], h, a) && d.push(a[h]);
                return d
            }

            var r = /^(\/?|)([\s\S]*?)((?:\.{1,2}|[^\/]+?|)(\.[^.\/]*|))(?:[\/]*)$/;
            l.resolve = function () {
                for (var a = "", d = !1, n = arguments.length - 1; -1 <= n && !d; n--) {
                    var t = 0 <= n ? arguments[n] :
                        c.cwd();
            ...
            l.relative = function (a, c) {
                ...
                for (var h = d(a.split("/")), b = d(c.split("/")), f = Math.min(h.length, b.length), F = f, u = 0; u < f; u++)if (h[u] !== b[u]) {
                    F = u;
                    break
                }
                f = [];
                for (u = F; u < h.length; u++)f.push("..");
        ...
        {"node_modules/process/browser.js": 7}], 7: [function (p, v, l) {
        function c() {
        }
        ...
        var e = p("./util"), k = Object.prototype.hasOwnProperty;
        c.fromArray = function (e, d) {
            for (var a = new c, h = 0, n = e.length; h < n; h++)a.add(e[h],
                d);
            return a
        };
        ...
        c.prototype.add = function (c, d) {
            var a = e.toSetString(c), h = k.call(this._set, a), n = this._array.length;
        ...
        c.prototype.indexOf = function (c) {
            ...
            if (k.call(this._set, d))return this._set[d];
        ...
        l.ArraySet = c
    }, {"./util": 17}], 9: [function (p, v, l) {
        var c = p("./base64");
        l.encode = function (e) {
            var k = "", r = 0 > e ? (-e << 1) + 1 : (e << 1) + 0;
            do e = r & 31, r >>>= 5, 0 < r && (e |= 32), k += c.encode(e); while (0 < r);
            return k
        };
        l.decode = function (e, k, r) {
            var d = e.length, a = 0, h = 0, n, t;
            do {
                if (k >= d)throw Error("Expected more digits in base 64 VLQ value.");
                t = c.decode(e.charCodeAt(k++));
                if (-1 === t)throw Error("Invalid base64 digit: " + e.charAt(k - 1));
                n = !!(t & 32);
                t &= 31;
                a += t << h;
                h += 5
    ...
    }, {"./base64": 10}], 10: [function (p, v, l) {
        var c = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".split("");
        l.encode = function (e) {
            if (0 <= e && e < c.length)return c[e];
        ...
        function c(e, k, r, d, a, h) {
            var n = Math.floor((k - e) / 2) + e, t = a(r,
                d[n], !0);
        ...
        var e = p("./util");
        c.prototype.unsortedForEach =
            function (c, e) {
                this._array.forEach(c, e)
            };
        c.prototype.add = function (c) {
            var k = this._last, d = k.generatedLine, a = c.generatedLine, h = k.generatedColumn, n = c.generatedColumn;
        ...
        function e(k, l, d, a) {
            if (d < a) {
                ...
                for (var n = k[a], t = d; t < a; t++)0 >= l(k[t], n) && (h += 1, c(k, h, t));
                c(k, h + 1, t);
                h += 1;
                e(k, l, d, h - 1);
                e(k, l, h + 1, a)
        ...
        function e(b) {
            ...
            var c = d.getArg(a,
                "sources"), u = d.getArg(a, "names", []), e = d.getArg(a, "sourceRoot", null), n = d.getArg(a, "sourcesContent", null), k = d.getArg(a, "mappings"), a = d.getArg(a, "file", null);
        ...
        function r(b) {
            ...
            this._sections = a.map(function (b) {
                ...
                var a = d.getArg(b, "offset"), f = d.getArg(a, "line"), u = d.getArg(a,
                    "column");
                if (f < e.line || f === e.line && u < e.column)throw Error("Section offsets must be ordered and non-overlapping.");
                e = a;
                return{generatedOffset: {generatedLine: f + 1, generatedColumn: u + 1}, consumer: new c(d.getArg(b, "map"))}
            })
        }

        var d = p("./util"), a = p("./binary-search"), h = p("./array-set").ArraySet, n = p("./base64-vlq"), t = p("./quick-sort").quickSort;
        ...
        c.prototype.eachMapping = function (b, a, e) {
            ...
            e.map(function (b) {
                ...
                return{source: a, generatedLine: b.generatedLine,
        ...
        c.prototype.allGeneratedPositionsFor = function (b) {
            var c = d.getArg(b, "line"), e = {source: d.getArg(b, "source"), originalLine: c, originalColumn: d.getArg(b, "column", 0)};
            null != this.sourceRoot && (e.source = d.relative(this.sourceRoot, e.source));
            if (!this._sources.has(e.source))return[];
            e.source = this._sources.indexOf(e.source);
            var u = [], e = this._findMapping(e,
                this._originalMappings, "originalLine", "originalColumn", d.compareByOriginalPositions, a.LEAST_UPPER_BOUND);
            if (0 <= e) {
                var h = this._originalMappings[e];
                if (void 0 === b.column)for (c = h.originalLine; h && h.originalLine === c;)u.push({line: d.getArg(h, "generatedLine", null), column: d.getArg(h, "generatedColumn", null), lastColumn: d.getArg(h, "lastGeneratedColumn", null)}), h = this._originalMappings[++e]; else for (b = h.originalColumn; h && h.originalLine === c && h.originalColumn == b;)u.push({line: d.getArg(h, "generatedLine", null), column: d.getArg(h,
                    "generatedColumn", null), lastColumn: d.getArg(h, "lastGeneratedColumn", null)}), h = this._originalMappings[++e]
            }
            return u
        };
        ...
        e.fromSourceMap = function (b) {
            var a = Object.create(e.prototype), c = a._names = h.fromArray(b._names.toArray(), !0), u = a._sources = h.fromArray(b._sources.toArray(), !0);
            ...
            for (var n = a.__generatedMappings = [], l = a.__originalMappings = [], r = 0, p = b.length; r < p; r++) {
                var B = b[r], x = new k;
        ...
        Object.defineProperty(e.prototype, "sources", {get: function () {
            return this._sources.toArray().map(function (b) {
                return null !=
                    this.sourceRoot ? d.join(this.sourceRoot, b) : b
            }, this)
        }});
        e.prototype._parseMappings = function (b, a) {
            for (var c = 1, f = 0, e = 0, h = 0, l = 0, r = 0, p = b.length, x = 0, v = {}, A = {}, E = [], H = [], z, D, q, C, K; x < p;)if (";" === b.charAt(x))c++, x++, f = 0; else if ("," === b.charAt(x))x++; else {
                z = new k;
                z.generatedLine = c;
                for (C = x; C < p && !this._charIsMappingSeparator(b, C); C++);
                D = b.slice(x, C);
                if (q = v[D])x += D.length; else {
                    for (q = []; x < C;)n.decode(b, x, A), K = A.value, x = A.rest, q.push(K);
                    if (2 === q.length)throw Error("Found a source, but no line and column");
                    if (3 ===
                        q.length)throw Error("Found a source and line, but no column");
                    v[D] = q
                }
        ...
        e.prototype._findMapping = function (b, c, d, e, h, n) {
            if (0 >= b[d])throw new TypeError("Line must be greater than or equal to 1, got " + b[d]);
            if (0 > b[e])throw new TypeError("Column must be greater than or equal to 0, got " + b[e]);
        ...
        e.prototype.computeColumnSpans = function () {
            for (var b = 0; b < this._generatedMappings.length; ++b) {
                ...
                a.lastGeneratedColumn =
                    Infinity
            }
        };
        e.prototype.originalPositionFor = function (b) {
            var a = {generatedLine: d.getArg(b, "line"), generatedColumn: d.getArg(b, "column")};
            ...
            if (0 <= b && (b = this._generatedMappings[b], b.generatedLine === a.generatedLine)) {
                ...
                return{source: a, line: d.getArg(b, "originalLine", null), column: d.getArg(b, "originalColumn", null), name: e}
            }
        ...
        e.prototype.sourceContentFor = function (b, a) {
            ...
            null != this.sourceRoot && (b = d.relative(this.sourceRoot,
                b));
        ...
        e.prototype.generatedPositionFor = function (b) {
            ...
            a = {source: a, originalLine: d.getArg(b, "line"), originalColumn: d.getArg(b, "column")};
            ...
            return 0 <= b && (b = this._originalMappings[b], b.source === a.source) ? {line: d.getArg(b, "generatedLine",
                null), column: d.getArg(b, "generatedColumn", null), lastColumn: d.getArg(b, "lastGeneratedColumn", null)} : {line: null, column: null, lastColumn: null}
        };
        ...
        Object.defineProperty(r.prototype, "sources", {get: function () {
            for (var a = [], c = 0; c < this._sections.length; c++)for (var d = 0; d < this._sections[c].consumer.sources.length; d++)a.push(this._sections[c].consumer.sources[d]);
            return a
        }});
        r.prototype.originalPositionFor =
            function (b) {
                var c = {generatedLine: d.getArg(b, "line"), generatedColumn: d.getArg(b, "column")}, e = a.search(c, this._sections, function (a, b) {
                    var c = a.generatedLine - b.generatedOffset.generatedLine;
                    return c ? c : a.generatedColumn - b.generatedOffset.generatedColumn
                });
                return(e = this._sections[e]) ? e.consumer.originalPositionFor({line: c.generatedLine - (e.generatedOffset.generatedLine - 1), column: c.generatedColumn - (e.generatedOffset.generatedLine === c.generatedLine ? e.generatedOffset.generatedColumn - 1 : 0), bias: b.bias}) : {source: null,
        ...
        r.prototype.generatedPositionFor = function (a) {
            for (var b = 0; b < this._sections.length; b++) {
                ...
                if (-1 !==
                    c.consumer.sources.indexOf(d.getArg(a, "source"))) {
                    var e = c.consumer.generatedPositionFor(a);
                    if (e)return{line: e.line + (c.generatedOffset.generatedLine - 1), column: e.column + (c.generatedOffset.generatedLine === e.line ? c.generatedOffset.generatedColumn - 1 : 0)}
                }
            }
        ...
        r.prototype._parseMappings = function (a, c) {
            ...
            for (var b = 0; b < this._sections.length; b++)for (var f = this._sections[b], e = f.consumer._generatedMappings, h = 0; h < e.length; h++) {
                var n =
                    e[h], k = f.consumer._sources.at(n.source);
                null !== f.consumer.sourceRoot && (k = d.join(f.consumer.sourceRoot, k));
                this._sources.add(k);
                var k = this._sources.indexOf(k), l = f.consumer._names.at(n.name);
                this._names.add(l);
                l = this._names.indexOf(l);
                n = {source: k, generatedLine: n.generatedLine + (f.generatedOffset.generatedLine - 1), generatedColumn: n.generatedColumn + (f.generatedOffset.generatedLine === n.generatedLine ? f.generatedOffset.generatedColumn - 1 : 0), originalLine: n.originalLine, originalColumn: n.originalColumn, name: l};
    ...
    }, {"./array-set": 8, "./base64-vlq": 9, "./binary-search": 11, "./quick-sort": 13, "./util": 17}], 15: [function (p, v, l) {
        function c(a) {
            a || (a = {});
            this._file = k.getArg(a, "file", null);
            this._sourceRoot = k.getArg(a, "sourceRoot", null);
            this._skipValidation = k.getArg(a, "skipValidation",
                !1);
            this._sources = new r;
            this._names = new r;
        ...
        var e = p("./base64-vlq"), k = p("./util"), r = p("./array-set").ArraySet, d = p("./mapping-list").MappingList;
        c.prototype._version = 3;
        c.fromSourceMap = function (a) {
            var d = a.sourceRoot, e = new c({file: a.file, sourceRoot: d});
            a.eachMapping(function (a) {
                var b = {generated: {line: a.generatedLine, column: a.generatedColumn}};
                null != a.source && (b.source = a.source, null != d && (b.source = k.relative(d, b.source)), b.original = {line: a.originalLine, column: a.originalColumn},
        ...
        c.prototype.addMapping = function (a) {
            var c = k.getArg(a, "generated"), d = k.getArg(a, "original", null), e = k.getArg(a, "source", null);
            ...
            this._mappings.add({generatedLine: c.line,
                generatedColumn: c.column, originalLine: null != d && d.line, originalColumn: null != d && d.column, source: e, name: a})
        };
            ...
            function (a, c, d) {
                ...
                this._mappings.unsortedForEach(function (c) {
                    if (c.source === e && null != c.originalLine) {
                        var n = a.originalPositionFor({line: c.originalLine, column: c.originalColumn});
                        null != n.source && (c.source = n.source, null != d && (c.source =
                            k.join(d, c.source)), null != b && (c.source = k.relative(b, c.source)), c.originalLine = n.line, c.originalColumn = n.column, null != n.name && (c.name = n.name))
                    }
                    n = c.source;
        ...
        c.prototype._validateMapping = function (a, c, d, e) {
            if (!(a && "line"in a && "column"in a && 0 < a.line &&
                0 <= a.column && !c && !d && !e || a && "line"in a && "column"in a && c && "line"in c && "column"in c && 0 < a.line && 0 <= a.column && 0 < c.line && 0 <= c.column && d))throw Error("Invalid mapping: " + JSON.stringify({generated: a, source: d, original: c, name: e}));
        };
        c.prototype._serializeMappings = function () {
            for (var a = 0, c = 1, d = 0, l = 0, b = 0, f = 0, r = "", u, p, I, G = this._mappings.toArray(), v = 0, B = G.length; v < B; v++) {
                p = G[v];
                u = "";
                if (p.generatedLine !== c)for (a = 0; p.generatedLine !== c;)u += ";", c++; else if (0 < v) {
                    if (!k.compareByGeneratedPositionsInflated(p, G[v - 1]))continue;
                    u += ","
                }
        ...
        c.prototype.toJSON = function () {
            var a = {version: this._version, sources: this._sources.toArray(), names: this._names.toArray(), mappings: this._serializeMappings()};
        ...
        "./base64-vlq": 9, "./mapping-list": 12, "./util": 17}], 16: [function (p, v, l) {
        ...
        var e = p("./source-map-generator").SourceMapGenerator, k = p("./util"), r = /(\r?\n)/;
        c.fromStringWithSourceMap = function (d, a, e) {
            function h(a, b) {
                if (null === a || void 0 === a.source)l.add(b); else {
                    var f = e ? k.join(e, a.source) : a.source;
                    l.add(new c(a.originalLine, a.originalColumn, f, b, a.name))
                }
            }

            var l = new c, b = d.split(r), f = function () {
                var a = b.shift(), c = b.shift() || "";
                return a + c
            }, p = 1, u = 0, v = null;
            a.eachMapping(function (a) {
                if (null !== v)if (p < a.generatedLine)h(v, f()), p++, u = 0; else {
                    var c = b[0], d = c.substr(0, a.generatedColumn - u);
                ...
                for (; p < a.generatedLine;)l.add(f()), p++;
        ...
        c.prototype.walk = function (c) {
            for (var a, d = 0, e = this.children.length; d < e; d++)a = this.children[d], a.$$$isSourceNode$$$ ? a.walk(c) : "" !== a && c(a, {source: this.source, line: this.line, column: this.column, name: this.name})
        };
        c.prototype.join = function (c) {
            var a, d, e = this.children.length;
            if (0 < e) {
                a = [];
                for (d = 0; d < e - 1; d++)a.push(this.children[d]), a.push(c);
        ...
        c.prototype.walkSourceContents = function (c) {
            for (var a =
                0, d = this.children.length; a < d; a++)this.children[a].$$$isSourceNode$$$ && this.children[a].walkSourceContents(c);
            for (var e = Object.keys(this.sourceContents), a = 0, d = e.length; a < d; a++)c(k.fromSetString(e[a]), this.sourceContents[e[a]])
        };
        c.prototype.toString = function () {
            var c = "";
        ...
        c.prototype.toStringWithSourceMap = function (c) {
            var a = "", d = 1, k = 0, l = new e(c), b = !1, f = null, p = null, u = null, r = null;
            this.walk(function (c, e) {
                a += c;
                null !== e.source && null !== e.line && null !== e.column ? (f === e.source &&
                    p === e.line && u === e.column && r === e.name || l.addMapping({source: e.source, original: {line: e.line, column: e.column}, generated: {line: d, column: k}, name: e.name}), f = e.source, p = e.line, u = e.column, r = e.name, b = !0) : b && (l.addMapping({generated: {line: d, column: k}}), f = null, b = !1);
                for (var h = 0, n = c.length; h < n; h++)10 === c.charCodeAt(h) ? (d++, k = 0, h + 1 === n ? (f = null, b = !1) : b && l.addMapping({source: e.source, original: {line: e.line, column: e.column}, generated: {line: d, column: k}, name: e.name})) : k++
            });
            this.walkSourceContents(function (a, b) {
                l.setSourceContent(a,
                    b)
            });
            return{code: a, map: l}
        };
        l.SourceNode = c
    }, {"./source-map-generator": 15, "./util": 17}], 17: [function (p, v, l) {
        function c(a) {
            return(a = a.match(n)) ? {scheme: a[1], auth: a[2], host: a[3], port: a[4], path: a[5]} : null
        }
        ...
        function k(a) {
            ...
            a = l.isAbsolute(b);
            for (var b = b.split(/\/+/), h, k = 0, n = b.length - 1; 0 <= n; n--)h = b[n], "." ===
                h ? b.splice(n, 1) : ".." === h ? k++ : 0 < k && ("" === h ? (b.splice(n + 1, k), k = 0) : (b.splice(n, 2), k--));
            b = b.join("/");
            "" === b && (b = a ? "/" : ".");
        ...
        l.join = function (a, d) {
            ...
            var b = c(d), f = c(a);
            f && (a = f.path || "/");
            if (b && !b.scheme)return f && (b.scheme = f.scheme), e(b);
            if (b || d.match(t))return d;
            if (f && !f.host && !f.path)return f.host = d, e(f);
    ...
    }, {"./lib/source-map-consumer": 14, "./lib/source-map-generator": 15, "./lib/source-node": 16}], 19: [function (p, v, l) {
        (function (c, e) {
            function k() {
                return"browser" === J ? !0 : "node" === J ? !1 : "undefined" !== typeof window && "function" === typeof XMLHttpRequest && !(window.require && window.module && window.process &&
            ...
            function a(a) {
                ...
                if (!b) {
                    var c = C(a.source);
                    c ? (b = E[a.source] = {url: c.url, map: new M(c.map)}, b.map.sourcesContent && b.map.sources.forEach(function (a, c) {
            ...
            function h(b) {
                ...
                return c ? (b = a({source: c[2], line: +c[3], column: c[4] - 1}), "eval at " + c[1] + " (" + b.source + ":" + b.line + ":" + (b.column + 1) + ")") : (c = /^eval at ([^(]+) \((.+)\)$/.exec(b)) ? "eval at " + c[1] + " (" + h(c[2]) + ")" : b
            }

            function n() {
                var a, b = "";
                this.isNative() ? b = "native" : (a = this.getScriptNameOrSourceURL(), !a && this.isEval() && (b = this.getEvalOrigin(),
                    b += ", "), b = a ? b + a : b + "<anonymous>", a = this.getLineNumber(), null != a && (b += ":" + a, (a = this.getColumnNumber()) && (b += ":" + a)));
                a = "";
            ...
            var M = p("source-map").SourceMapConsumer, I = p("path"), G = p("fs"), L = !1, B = !1, x = !1, J = "auto", A = {}, E = {}, H = /^data:application\/json[^,]+base64,/, z = [], D = [], q = r(z);
            z.push(function (a) {
                a = a.trim();
            ...
            l.install = function (a) {
                a = a || {};
                if (a.environment && (J = a.environment, -1 === ["node", "browser", "auto"].indexOf(J)))throw Error("environment " + J + " was unknown. Available options are {auto, browser, node}");
                ...
                if (a.hookRequire && !k()) {
                    var b = p("module"), d = b.prototype._compile;
                ...
                !B && ("handleUncaughtExceptions"in a ? a.handleUncaughtExceptions :
                    1) && "object" === typeof c && null !== c && "function" === typeof c.on && (B = !0, u())
            }
