...
describe('contain()', function () {
    ...
    it('tests objects', function (done) {
        ...
        expect(Hoek.contain({ a: [
            ...
            { b: 1 },
            { d: 3 }
        ] }, { deep: true, part: true })).to.be.true();
        expect(Hoek.contain({ a: [
            { b: 1 },
            { c: 2 },
            { d: 3, e: 4 }
            ...
            { b: 1 },
            { d: 3 }
        ] }, { deep: true, part: false })).to.be.false();
        expect(Hoek.contain({ a: [
            { b: 1 },
            { c: 2 },
            { d: 3, e: 4 }
            ...
            { b: 1 },
            { d: 3 }
        ] }, { deep: true, only: true })).to.be.false();
        expect(Hoek.contain({ a: [
            { b: 1 },
            { c: 2 },
            { d: 3, e: 4 }
            ...
            { b: 1 },
            { d: 3 }
        ] }, { deep: true, only: false })).to.be.true();
