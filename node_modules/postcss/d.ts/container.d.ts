 ...
 */
export default
class Container extends Node implements postcss.Container {
    private indexes;
    private lastEach;
    /**
     ...
     */
        each(callback:(node:Node, index:number) => any):boolean
...
|
     ...
     */
        walk(callback:(node:Node, index:number) => any):boolean
...
|
    ...
    walkDecls(callback:(decl:postcss.Declaration, index:number) => any):boolean
...
|
     ...
     * container.
     */
        walkRules(selectorFilter:string

|
    RegExp, callback:(atRule:Rule, index:number) => any
):
    boolean
|
    void;

    walkRules(callback:(atRule:Rule, index:number) => any):boolean
...
|
     ...
     * container.
     */
        walkAtRules(nameFilter:string

|
    RegExp, callback:(atRule:AtRule, index:number) => any
):
    boolean
|
    void;

    walkAtRules(callback:(atRule:AtRule, index:number) => any):boolean
...
|
     ...
     */
        walkComments(callback:(comment:Comment, indexed:number) => any):void
...
Container;
replaceValues(pattern
:
string | RegExp, callbackOrReplaceValue
:
string | {
    (substring
:
...
every(callback
:
(node:Node, index:number, nodes:Node[]) => any, thisArg ? : any
):
boolean;
/**
...
some(callback
:
(node:Node, index:number, nodes:Node[]) => boolean, thisArg ? : any
):
boolean;
/**
...
normalize(node
:
Node | string, sample ? : Node, type ? : string | boolean
):
Node[];
protected
normalize(props
:
postcss.AtRuleNewProps | postcss.RuleNewProps | postcss.DeclarationNewProps | postcss.CommentNewProps, sample ? : Node, type ? : string | boolean
):
Node[];
rebuild(node
:
...
any;
eachRule(selectorFilter
:
any, callback ? : any
):
any;
eachAtRule(nameFilter
:
any, callback ? : any
):
any;
eachComment(selectorFilter
:
any, callback ? : any
):
any;
