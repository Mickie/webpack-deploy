...
function preset(context) {
    ...
    return {
        plugins: [
            [_babelPluginTransformEs2015TemplateLiterals2.default, { loose: loose, spec: spec }],
            _babelPluginTransformEs2015Literals2.default,
            _babelPluginTransformEs2015FunctionName2.default,
            [_babelPluginTransformEs2015ArrowFunctions2.default, { spec: spec }],
            ...
            [_babelPluginTransformEs2015Destructuring2.default, optsLoose],
            ...
            [_babelPluginTransformRegenerator2.default, { async: false, asyncGenerators: false }]
        ].filter(Boolean) };
}
