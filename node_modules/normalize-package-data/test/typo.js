...
test('typos', function (t) {
    ...
    normalize({name: "name", version: "1.2.5", bugs: {web: "url", name: "url"}}, warn)
    ...
    normalize({name: "name", version: "1.2.5", script: {server: "start", tests: "test"}}, warn)
    ...
    normalize({name: "name", version: "1.2.5", scripts: {server: "start", tests: "test"}}, warn)
    ...
    normalize({name: "name", version: "1.2.5", scripts: {server: "start", tests: "test", start: "start", test: "test"}}, warn)
    ...
    normalize({private: true, name: "name", version: "1.2.5", scripts: {server: "start", tests: "test"}}, warn)
