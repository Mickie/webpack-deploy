...
test('test prr(o, key, value) form', function (t) {
    ...
    t.deepEqual(
        ...
        , {
            enumerable: false, configurable: false, writable: false, value: 'bar'
        }
...
test('test multiple key:value pairs', function (t) {
    ...
    [ 'one', 'two', 'obj' ].forEach(function (p) {
        t.deepEqual(
            ...
            , {
                enumerable: false, configurable: false, writable: false, value: p == 'obj' ? { o: 'o' } : p.toUpperCase()
            }
            , 'correct property descriptor'
        )
    })
...
test('test descriptor options', function (t) {
    ...
    t.deepEqual(
        Object.getOwnPropertyDescriptor(o, 'foo')
        , {
            enumerable: true, configurable: false, writable: false, value: 'bar'
        }
        , 'correct property descriptor'
    )
    ...
    t.deepEqual(
        ...
        , {
            enumerable: true, configurable: true, writable: false, value: 'bar2'
        }
        , 'correct property descriptor'
    )
    ...
    t.deepEqual(
        ...
        , {
            enumerable: true, configurable: true, writable: true, value: 'bar3'
        }
        , 'correct property descriptor'
    )
