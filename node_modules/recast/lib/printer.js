    ...
    switch (n.type) {
        ...
        case "ArrowFunctionExpression":
            ...
            if (
                !options.arrowParensAlways &&
                    ...
                    n.params[0].type === 'Identifier' && !n.params[0].typeAnnotation && !n.returnType
                ) {
        ...
        case "VariableDeclaration":
            ...
            if (!namedTypes.ForStatement.check(parentNode) && !namedTypes.ForInStatement.check(parentNode) && !(namedTypes.ForOfStatement &&
                namedTypes.ForOfStatement.check(parentNode)) && !(namedTypes.ForAwaitStatement &&
        ...
        case "FunctionTypeAnnotation":
            ...
            var needsColon =
                isArrowFunctionTypeAnnotation && !namedTypes.FunctionTypeParam.check(parent);
...
function printExportDeclaration(path, options, print) {
    ...
    if (lastNonSpaceCharacter(lines) !== ";" && !(decl.declaration &&
