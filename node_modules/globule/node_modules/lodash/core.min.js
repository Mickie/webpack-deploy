...
(function () {
    ...
    function l(n, t, r) {
        for (var e = -1, u = n.length; ++e < u;) {
            var o = n[e], i = t(o);
            if (null != i && (c === nn ? i === i : r(i, c)))var c = i, f = o
        }
        return f
    }
    ...
    function s(n, r, e, u, o) {
        ...
        for (e || (e = D), o || (o = []); ++i < c;) {
            var f = n[i];
            0 < r && e(f) ? 1 < r ? s(f, r - 1, e, u, o) : t(o, f) : u || (o[o.length] = f);
        }
        return o
    }
    ...
    function b(n, t, r, e, u) {
        return n === t || (null == n || null == t || !H(n) && !K(t) ? n !== n && t !== t : g(n, t, b, r, e, u))
    }

    function g(n, t, r, e, u, o) {
        var i = Sn(n), c = Sn(t), f = "[object Array]", a = "[object Array]";
        i || (f = hn.call(n), f = "[object Arguments]" == f ? "[object Object]" : f), c || (a = hn.call(t), a = "[object Arguments]" == a ? "[object Object]" : a);
        var l = "[object Object]" == f, c = "[object Object]" == a, a = f == a;
        o || (o = []);
        ...
        return 2 & u || (i = l && pn.call(n, "__wrapped__"), f = c && pn.call(t, "__wrapped__"), !i && !f) ? !!a && (r = R(n, t, r, e, u, o),
            o.pop(), r) : (i = i ? n.value() : n, f = f ? t.value() : t, r = r(i, f, e, u, o), o.pop(), r)
    }

    function _(n) {
        return typeof n == "function" ? n : null == n ? Y : (typeof n == "object" ? m : r)(n)
    }
    ...
    function B(n, t, r, e, u, o) {
        ...
        for (var c = -1, f = true, a = 1 & u ? [] : nn; ++c < i;) {
            ...
            if (a) {
                if (!w(t, function (n, t) {
                    if (!z(a, t) && (l === n || r(l, n, e, u, o)))return a.push(t)
                })) {
                    f = false;
                    break
                }
    ...
    function Q(n) {
        return typeof n == "string" || !Sn(n) && K(n) && "[object String]" == hn.call(n)
    }
    ...
    function Z(n, r, e) {
        var u = qn(r), o = v(r, u);
        null != e || H(r) && (o.length || !u.length) || (e = r, r = n, n = this, o = v(r, qn(r)));
        ...
        return mn(o, function (e) {
            ...
            n[e] = u, c && (n.prototype[e] = function () {
                ...
                if (i || r) {
                    ...
                    return(e.__actions__ = E(this.__actions__)).push({func: u, args: arguments, thisArg: n}), e.__chain__ = r, e
                }
    ...
    var mn = function (n, t) {
        ...
        n:{
            for (t = _(t), e = n.length, r += -1; ++r < e;)if (t(n[r], r, n)) {
                n = r;
                break n
            }
            n = -1
        ...
        return f(n, Tn(t) || 0, r)
    }), Sn = Array.isArray, Fn = Number, Tn = Number, Bn = S(function (n, t) {
        N(t, _n(t), n)
    }), Rn = S(function (n, t) {
        N(t, I(t), n)
    ...
    }), qn = _n, $n = I, Pn = function (n) {
        return xn(q(n, nn, $), n + "")
    }(function (n, t) {
        return null == n ? {} : O(n, d(t, An))
    });
    o.assignIn = Rn, o.before = J, o.bind = wn, o.chain = function (n) {
        ...
        var r = dn(n);
        return null == t ? r : Bn(r, t)
    }, o.defaults = In, o.defer = kn, o.delay = Nn, o.filter = function (n, t) {
        return p(n, _(t))
    }, o.flatten = $,
        o.flattenDeep = function (n) {
            return(null == n ? 0 : n.length) ? s(n, tn) : []
        ...
        return J(2, n)
    }, o.pick = Pn, o.slice = function (n, t, r) {
        var e = null == n ? 0 : n.length;
        return r = r === nn ? e : +r, e ? A(n, null == t ? 0 : +t, r) : []
    }, o.sortBy = function (n, t) {
        var e = 0;
        return t = _(t),
            d(d(n,function (n, r, u) {
    ...
    }, o.values = X, o.extend = Rn, Z(o, o), o.clone = function (n) {
        return H(n) ? Sn(n) ? E(n) : N(n, _n(n)) : n
    }, o.escape = function (n) {
        return(n = W(n)) && en.test(n) ? n.replace(rn, fn) : n
    }, o.every = function (n, t, r) {
        return t = r ? nn : t, a(n, _(t))
    }, o.find = En, o.forEach = C, o.has = function (n, t) {
        return null != n && pn.call(n, t)
    }, o.head = P, o.identity = Y, o.indexOf = z, o.isArguments = n, o.isArray = Sn, o.isBoolean = function (n) {
        return true === n || false === n || K(n) && "[object Boolean]" == hn.call(n)
    }, o.isDate = function (n) {
        return K(n) && "[object Date]" == hn.call(n)
    }, o.isEmpty = function (t) {
        return U(t) && (Sn(t) || Q(t) || V(t.splice) || n(t)) ? !t.length : !_n(t).length;
        ...
        var n = {};
        return h(o, function (t, r) {
            pn.call(o.prototype, r) || (n[r] = t)
        }), n
    }(), {chain: false}), o.VERSION = "4.16.6", mn("pop join replace reverse split push shift sort splice unshift".split(" "), function (n) {
