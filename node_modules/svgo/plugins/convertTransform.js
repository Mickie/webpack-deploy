    ...
    for (var i = 0; i < transforms.length; i++) {
        ...
        if (
            params.shortTranslate &&
                ...
                transform.data.length === 2 && !transform.data[1]
            ) {
            transform.data.pop();
        }
    ...
    return transforms.filter(function (transform) {
        ...
        if (
            ['translate', 'rotate', 'skewX', 'skewY'].indexOf(transform.name) > -1 &&
                (transform.data.length == 1 || transform.name == 'rotate') && !transform.data[0] ||
                ...
                transform.name == 'matrix' &&
                    transform.data[0] == 1 &&
                    transform.data[3] == 1 && !(transform.data[1] || transform.data[2] || transform.data[4] || transform.data[5])
            ) {
            return false;
        }
